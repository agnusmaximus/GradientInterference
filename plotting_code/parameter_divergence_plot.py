...
parameter_divergence_plots_directory_name = "parameter_divergence"
parameter_divergence_directory = "%s/%s" % (output_directory, parameter_divergence_plots_directory_name)

if not os.path.exists(parameter_divergence_directory):
    os.makedirs(parameter_divergence_directory)
...
def plot_all_parameter_diffs(all_models):
    for batchsize in all_models.keys():
        ...
        plt.savefig("%s/batchsize_%d_parameter_divergence.png" % (parameter_divergence_directory, int(batchsize)))
    ...
    plt.savefig("%s/allbatchsize.png" % parameter_divergence_directory)
...
def plot_all_parameter_diffs_compare_normalized_dist_and_dist(all_models):
    ...
    for batchsize in all_models.keys():
        ...
        plt.savefig("%s/batchsize_%d_parameter_divergence_normalized.png" % (parameter_divergence_directory, int(batchsize)))
    ...
    for batchsize in all_models.keys():
        ...
        plt.savefig("%s/batchsize_%d_parameter_divergence_non_normalized.png" % (parameter_divergence_directory, int(batchsize)))
...
def plot_all_batchsize_all_non_normalized_dists(all_models):
    ...
    plt.savefig("%s/all_parameter_divergence_non_normalized.png" % parameter_divergence_directory)
...
def plot_train_test_losses(all_models, all_train_test_losses):
    ...
    for batchsize in all_models.keys():
        ...
        plt.savefig("%s/TrainTestParameterDifferencesNonNormalizedLosses%d.png" % (parameter_divergence_directory, int(batchsize)))
